...
ASSETS_ACCESS_BY_TOKEN = ENV_TOKENS.get('ASSETS_ACCESS_BY_TOKEN', ASSETS_ACCESS_BY_TOKEN)
ASSETS_TOKEN_ENCRYPTION_KEY = ENV_TOKENS.get('ASSETS_TOKEN_ENCRYPTION_KEY', ASSETS_TOKEN_ENCRYPTION_KEY)
ASSETS_TOKEN_TTL = ENV_TOKENS.get('ASSETS_TOKEN_TTL', ASSETS_TOKEN_TTL)
